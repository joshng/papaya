...
public abstract class Maybe<T> implements Iterable<T> {
  ...
  public static <T, U> Maybe.Pair<T, U> pairOnlyIfFrom(boolean condition, Supplier<? extends Map.Entry<? extends T, ? extends U>> value) {
  ...
  public static <K, V> Pair<K, V> definitePair(K key, V value) {
    return new Pair.DefinitePair<K, V>(com.joshng.util.collect.Pair.of(key, value));
  }
  ...
  private static class Definitely<T> extends Maybe<T> {
    ...
    @Override public <U> Pair<T, U> zip(Maybe<U> other) {
      return other.mapPair(u -> com.joshng.util.collect.Pair.of(value, u));
    }
  ...
  public abstract static class Pair<K, V> extends Maybe<Map.Entry<K, V>> implements Map.Entry<Maybe<K>, Maybe<V>> {
    ...
    private static class DefinitePair<K, V> extends Pair<K, V> {
      ...
      @Override public <U> Pair<Map.Entry<K, V>, U> zip(Maybe<U> other) {
        return other.mapPair(u -> com.joshng.util.collect.Pair.of(entry, u));
      }
