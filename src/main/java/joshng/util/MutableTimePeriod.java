...
public class MutableTimePeriod {
  public static final F<MutableTimePeriod, DateTime> GET_START_TIME = new F<MutableTimePeriod, DateTime>() {
    public DateTime apply(MutableTimePeriod from) {
      return from.getStartTime();
    }
  };
  public static final F<MutableTimePeriod, DateTime> GET_END_TIME = new F<MutableTimePeriod, DateTime>() {
    public DateTime apply(MutableTimePeriod from) {
