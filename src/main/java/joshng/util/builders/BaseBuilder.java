...
public abstract class BaseBuilder<T, SELF extends BaseBuilder<T, SELF>> implements Cloneable {
    ...
    public class DurationProperty extends BuilderProperty<Long, DurationProperty> {
        public PropertyValue<T, Long> of(long duration, TimeUnit timeUnit) { return as(timeUnit.toMillis(duration)); }
        public PropertyValue<T, Long> of(Duration duration) { return of(duration.getMillis()); }
        public DurationProperty withDefault(long duration, TimeUnit timeUnit) { return withDefault(timeUnit.toMillis(duration)); }
    ...
    protected <P> Property<P> property() { return new Property<>(); }
    protected <P> Property<P> propertyWithDefault(P defaultValue) { return this.<P>property().withDefault(defaultValue); }
    protected <P> Property<P> propertyWithDefaultFrom(Supplier<? extends P> supplier) { return this.<P>property().withDefaultFrom(supplier); }

    protected DurationProperty duration() { return new DurationProperty(); }
    protected DurationProperty durationWithDefault(long defaultDuration, TimeUnit timeUnit) { return duration().withDefault(defaultDuration, timeUnit); }
    protected <V> ListProperty<V> listProperty() { return new ListProperty<V>(); }
