...
public class PersistentList<T> extends AbstractSequentialList<T> {
    private static final F2 WITH = new F2<Object, PersistentList<Object>, PersistentList<Object>>() {
        @Override public PersistentList<Object> apply(Object input1, PersistentList<Object> input2) {
    ...
    public static <T> F2<T, PersistentList<T>, PersistentList<T>> with() {
        return WITH;
    }
