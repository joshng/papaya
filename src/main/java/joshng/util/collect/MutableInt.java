 ...
 */
public class MutableInt extends Number implements Comparable<MutableInt>, MutableReference<Integer> {
    ...
    /**
     * @deprecated use {@link #intValue()} instead, to avoid unnecessary boxing
     */
    @Deprecated
    @Override
    public Integer get() {
