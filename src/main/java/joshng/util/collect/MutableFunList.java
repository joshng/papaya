 ...
 * Time: 12:28 PM
 */
public class MutableFunList<T> extends ArrayList<T> implements FunIterable<T> {
    public MutableFunList(int initialCapacity) {
        super(initialCapacity);
    }

    public MutableFunList() {
    }

    public MutableFunList(Collection<? extends T> c) {
        super(c);
    }

    public static <T> MutableFunList<T> newMutableFunList() {
        return new MutableFunList<T>();
    }

    public static <T> MutableFunList<T> newMutableFunList(Iterable<T> items) {
        if (items instanceof Collection) return new MutableFunList<T>((Collection<T>)items);
        MutableFunList<T> list = newMutableFunList();
        for (T item : items) {
            list.add(item);
        }
        return list;
    ...
    /**
     * NOTE: this method does NOT alter this mutable collection.<p>
     * Use {@link #add(int, T)} to change the contained values.<p>
     * {@inheritDoc}
     */
    @Override
    ...
    /**
     * NOTE: this method does NOT alter this mutable collection.<p>
     * Use {@link #addAll} or {@link Iterables#addAll} to change this instance. <p>
     * {@inheritDoc}
     */
    ...
    /**
     * NOTE: this method does NOT alter this mutable collection.<p>
     * Use {@link #removeAll} to change this instance. <p>
     * {@inheritDoc}
     */
