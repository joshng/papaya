...
public class Reflect {
    ...
    public static <A extends Annotation> F<AnnotatedElement, A> annotationGetter(final Class<A> annotationClass) {
        return new F<AnnotatedElement, A>() { public A apply(AnnotatedElement input) {
    ...
    public static <G> F<Type, Class<? extends G>> genericTypeFinder(final int index) {
        return new F<Type, Class<? extends G>>() { public Class<? extends G> apply(Type input) {
    ...
    @Nullable public static <T> T castOrNull(Object obj, Class<T> castClass) {
